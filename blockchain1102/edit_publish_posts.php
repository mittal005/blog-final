...
if ($statusdropdown == 'Draft') {
   $query="UPDATE posts SET Title='$addTitle',Content='$postContent',seo_title='$seo_title',description='$description',url='$url',seo_schema='$schema',draftTime='$current_time',Status='$statusdropdown', Visibility='$visible',publihedOn='$date',  categoryName='$category_name',categoryType='$category_type' WHERE id={$edit_id}";
  ...
  header("Location:allposts.php?show=published");
  } 
        }
...
if ($statusdropdown == 'Publish') {
 ...
 $query="UPDATE posts SET Title='$addTitle',Content='$postContent',seo_title='$seo_title',description='$description',url='$url',seo_schema='$schema',publishTime='$current_time',Status='$statusdropdown', Visibility='$visible',publihedOn='$date',  categoryName='$category_name',categoryType='$category_type' WHERE id={$edit_id}";
  $update_query=mysqli_query($connection,$query);
