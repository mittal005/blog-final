...
$str_arr = explode (",",$selectCategory); 
      ?>
      <input type="checkbox" name="select_category[]" value="<?php echo $selectCategory; ?>" <?php if (in_array($name,$str_arr)) echo 'checked="checked"'; ?>/  class="mar_top_20"> <?php echo $name;    ?><br>            
                                <?php     
                                    }
                                        ?>
  </div>
