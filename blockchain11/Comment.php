...
<div class="row dash_row" id="filter">
  ...
  <div class="col-md-2">
    ...
    <td class="author_td"></td>
    <td><label></label></td>
    <td class="page_control"><label></label></td>
    <td><label></label></td>
    <td class="page_control"><button class="table_btn btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#quickedit" ><span class="fa fa-comment"></span></button></td>
