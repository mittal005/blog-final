     ...
     <div id="glance" class="collapse show" aria-labelledby="glanceone" data-parent="#accordion">
       <div class="card-body">
        <div class="row mar_bottom_20">
          ...
          <span><?php  echo  $total_posts_posts;       ?></span><a href="#">Post</a>
        </div>

<div class="col-md-6">
          <i class="fa fa-file"></i>
          <span><?php echo  $total_posts_pages;        ?></span><a href="#">Pages</a>
...
<div class="card-header" id="activityone">
 ...
 $select_query="SELECT * FROM quickdraft ORDER BY id DESC LIMIT 5";
    ...
    exit();
        ...
        <label><?php echo $title; ?></label> <span><a href="#"> <?php echo $time;  ?> </a></span>
        <?php
      }
      ?>
   </div>
