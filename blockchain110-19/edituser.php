...
if (isset($_POST['update'])) {
   ...
   $query="UPDATE newuser SET username='$username',email='$email', firstname='$firstname',  lastname='$lastname', password='$password',role='$role' WHERE id={$edit_id}";
...
<label>Password</label>
              <input type="password" class="form-control" id="password" name="password" value="<?php if(isset($password)){echo $password;} ?>" required>
