 ...
 <div class="container-fluid">
              <div class="row dash_row outer-w3-agile">
                <div class="col-md-5 ">
                  <form action="" method="post">
                    ...
                    <br>  
                            <label>Slug</label>
                    <input type="text" class="form-control" name="slug"  placeholder="Slug" value="" required="">
                    <br>
    ...
    exit();
                   ...
                   <label>Description</label>
                    <textarea class="form-control"  rows="5" required=""placeholder="Description" name="description"></textarea>
                    <div class="row">
...
if (isset($_POST['save_category'])) {
    ...
    date_default_timezone_set("Asia/Kolkata");
     ...
     $que="INSERT INTO category(name,slug,parentcategory,description,category_date)VALUES('$name','$slug','$parentcategory','$description','$current_time')";
...
if (!isset($_POST['selectByDate'])) {
  ...
  $post_query_count="SELECT * FROM category";
    ...
    <td><?php if(isset($parentcategory)){echo $parentcategory;}  ?></td>
