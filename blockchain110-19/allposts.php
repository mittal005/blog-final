...
while($row=mysqli_fetch_array($select_allposts)) {
  ...
  if ($Status=="Publish") {
   $query="UPDATE posts SET Title='$title',categoryName='$category',seo_title='$fname',publishTime='$fdate',onlyDate='$fdate' WHERE id={$id}";
  ...
  if ($Status=="Draft") {
   $query="UPDATE posts SET Title='$title',categoryName='$category',seo_title='$fname', draftTime='$fdate',onlyDate='$fdate' WHERE id={$id}";
  $update_query=mysqli_query($connection,$query);
  if (!$update_query) {
    printf("Error: %s\n", mysqli_error($connection));
    exit();
...
<!-- <a href="#edit<?php //echo $row['userid']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a>  -->
        ...
        <div class="dropdown-menu dropdown-menu-right" id="actionmenulist" aria-labelledby="actionmenu">
          <a class="dropdown-item" href="editpost1.php?edit=<?php echo $id;   ?>">Edit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil pad_left_40"></i
            ></a>
...
<ul class="pagination">
  ...
  <div class="modal-dialog" role="document">
   ...
   <input type="text" class="form-control" name="ftitle" id="title" required>
    ...
    <select class="form-control mar_top_20" name="category" id="category">
    ...
    exit();
                    ...
                    ?>
                                        <option <?php  echo 'selected="selected"'; ?>> <?php echo $parentcategory;    ?></option>
                                     <?php
                                      }
  ?>
  </select>
