...
</div> <input type="text" placeholder="SEO Title" class="pad form-control" name="seo_title"><br>
...
<textarea class="form-control pad" placeholder="Description" name="description"></textarea><br>
...
<input type="text" class="pad form-control" placeholder="URL" name="url">

<i class="fa fa-question-circle pad"></i>Schema
<input type="text" class="pad form-control" placeholder="Schema" name="schema">
