...
if (isset($_POST['update'])) {
   ...
   $query="UPDATE category SET name='$name',slug='$slug',parentcategory='$parentcategory',description='$description' WHERE id={$edit_id}";
...
<div class="container-fluid">
  <div class="row dash_row ">
    ...
    <input type="text" class="form-control" id="firstName" name="name" placeholder="" value="<?php echo $name; ?>" required=""> 
                    <br>  
                    <label>Slug</label>
    <input type="text" class="form-control" id="firstName" name="slug" placeholder="" value="<?php echo $slug; ?>" required="">
    <br>
                            <label> Parent Category</label>
                    <select class="form-control" name="parentcategory"value="<?php echo $parentcategory; ?>" required="">
                      <br>
    ...
    exit();
            ...
            <option <?php if($sname==$parentcategory) echo 'selected="selected"'; ?>> <?php echo $sname;    ?></option>
                   ...
                   <label>Description</label>
                    <textarea class="form-control" name="description" rows="5" value="<?php echo $description;    ?>"required=""><?php echo $description;    ?></textarea>
                    <div class="row">
