...
if(isset($_POST['saveDraft']))
{
 ...
 $query="INSERT INTO posts(username,Title,Content,Status,Visibility,Format,draftTime,categoryName,categoryType,seo_title,description, url,seo_schema)VALUES('$username','$addTitle','$postContent','$statusdropdown','$visible','$x','$current_time','$category_name','$category_type','$seo_title','$description','$url','$schema')";
...
if ($statusdropdown == 'Publish') {
 $query="INSERT INTO posts(username,Title,Content,Status,Visibility,Format,publishTime,categoryName,categoryType,seo_title,description, url,seo_schema)VALUES('$username','$addTitle','$postContent','$statusdropdown','$visible','$x','$current_time','$category_name','$category_type','$seo_title','$description','$url','$schema')";
  $create_post_query=mysqli_query($connection,$query);
  if (!$create_post_query) {
...
<input readonly type="text" name="countDisplay1" size="3" maxlength="3" value="60"><span> Characters Remaining</span><br>
</form>
...
<br>
<input readonly type="text" name="countDisplay" size="3" maxlength="3" value="160"> <span>Characters Remaining</span>
</form>
<br>
...
document.getElementById('btn1').innerHTML=value;
  ...
  (function (){
    ...
    function LimitCharacter(description) {
