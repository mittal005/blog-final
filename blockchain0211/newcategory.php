...
if (isset($_POST['save_category'])) {
    ...
    date_default_timezone_set("Asia/Kolkata");
     ...
     $que="INSERT INTO category(categoryName,slug,parentcategory,description,category_date)VALUES('$name','$slug','$parent_category','$description','$current_time')";
...
if (isset($_POST['selectByUsername'])) {
 ...
 $select_query="SELECT * FROM category WHERE categoryName LIKE '%$search%'";
 $select_all_categories_query=mysqli_query($connection, $select_query);
                if (!$select_all_categories_query) {
    printf("Error: %s\n", mysqli_error($connection));
    exit();
