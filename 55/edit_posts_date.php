...
if ($statusdropdown == 'Draft') {
   $query="UPDATE posts SET Title='$addTitle',Content='$postContent',seo_title='$seo_title',description='$description',url='$url',seo_schema='$schema',draftTime='$current_time',Status='$statusdropdown', Visibility='$visible',PublishedOn='$date',  categoryName='$category_name',categoryType='$category_type' WHERE id={$edit_id}";
  ...
  header("Location:allpost.php?display=date");
  } 
        }
...
if ($statusdropdown == 'Publish') {
 ...
 $query="UPDATE posts SET Title='$addTitle',Content='$postContent',seo_title='$seo_title',description='$description',url='$url',seo_schema='$schema',publishTime='$current_time',Status='$statusdropdown', Visibility='$visible',PublishedOn='$date',  categoryName='$category_name',categoryType='$category_type' WHERE id={$edit_id}";
  $update_query=mysqli_query($connection,$query);
...
<i class="fa fa-question-circle pad"></i>Title<form> <input type="text" class="pad form-control" name="seo_title" value="<?php echo $seo_title;   ?>"onKeyDown="textCounter1(this.form.seo_title,this.form.countDisplay1);" onKeyUp="textCounter1(this.form.seo_title,this.form.countDisplay1);"><br>
<input readonly type="text" name="countDisplay1" size="3" maxlength="3" value="0"><span> Characters Remaining</span><br>
</form><br>
<i class="fa fa-question-circle pad"></i>Description<form>
<textarea class="form-control pad" name="description"onKeyDown="textCounter(this.form.description,this.form.countDisplay1);" onKeyUp="textCounter(this.form.description,this.form.countDisplay1);"><?php echo $description;   ?></textarea><br>
<input readonly type="text" name="countDisplay1" size="3" maxlength="3" value="0"><span> Characters Remaining</span><br>
</form><br>
<br>
...
<div id="publish">
     ...
     <span id="answer3" style="display: none;">
         <input type="date" name="date" value="<?php echo $PublishedOn; ?>"></span>  
       </div>
</div>  
     </div>
     <br>
