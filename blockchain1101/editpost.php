...
<form>
<input type="text" class="pad form-control"name="seo_title"value="<?php echo $Title;   ?>" onKeyDown="textCounter1(this.form.seo_title,this.form.countDisplay1);" onKeyUp="textCounter1(this.form.seo_title,this.form.countDisplay1);"><br>
...
<form>
<textarea class="form-control pad"name="description"value="<?php echo $Title;   ?>"onKeyDown="textCounter(this.form.description,this.form.countDisplay);" onKeyUp="textCounter(this.form.description,this.form.countDisplay);"></textarea>
<br>
...
<input type="text" class="pad form-control" name="url" value="<?php echo $Title;   ?>">

<i class="fa fa-question-circle pad"></i>Schema
<input type="text" class="pad form-control" name="schema" value="<?php echo $Title;   ?>">
...
<div id="ncategory" class=" mar_top_20">
  <input type="text" class="form-control mar_top_20"  name="category_name" value="<?php echo $Title;   ?>">
