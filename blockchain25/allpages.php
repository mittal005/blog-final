...
<?php include("includes/sidenav.php"); ?>
        ...
        <div class="row dash_row outer-w3-agile">
            <div class="col-md-12">
              <div class="row">
          <div class="col-md-12">
         <a href="#"> All (<span></span>) </a> |  <a href="#"> Published </a> (<span></span>)  | <a href="#">  Draft </a>(<span></span>) |<a href="#"> Trash </a> (<span></span>) 
...
<div class="row dash_row" id="filter">
  ...
  <div class="col-md-2 col-offset-md-4">
    ...
    <td><label></label></td>
        <td class="page_control"><button class="table_btn btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#quickedit" ><span class="fa fa-ellipsis-v"></span></button></td>
