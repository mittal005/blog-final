...
<input type="password" class="form-control" name="password"  value="<?php if(isset($user_password)){echo $user_password;}else if(isset($updated_password)){echo $updated_password;}else{echo $common_password;}  ?>" required>
