...
$fid_query=mysqli_query($connection,$fid_select);
 ...
 $query="INSERT INTO pages(fid,username,user_id,Title,Content,Status,Visibility,draftTime,publihedOn,selectCategory,seo_title,description, url,seo_schema,image,createdDate)VALUES('$fid','$username','$user_id','$addTitle','$postContent','$statusdropdown','$visible','$current_time','$date','$c','$seo_title','$description','$url','$schema','$post_image','$current_time')";
...
if ($statusdropdown == 'Publish') {
 $query="INSERT INTO pages(fid,username,user_id,Title,Content,Status,Visibility,publishTime,publihedOn,selectCategory,seo_title,description, url,seo_schema,image,createdDate)VALUES('$fid','$username','$user_id','$addTitle','$postContent','$statusdropdown','$visible','$current_time','$date','$c','$seo_title','$description','$url','$schema','$post_image','$current_time')";
  $create_post_query=mysqli_query($connection,$query);
  if (!$create_post_query) {
      printf("Error: %s\n", mysqli_error($connection));
    exit();
  ...
  <div class="col-md-12">
    <div class="outer-w3-agile">
      <h6>Featured image</h6>
       <span>Add your Featured image:</span> 
...
</div> <input type="text" id="myText1" class="pad form-control" name="seo_title"><br>
<span id="wordCount1" class="label_border pad">0</span><span>Characeter. Most search engines use a maximum of 60 characters for the Title.</span><br><br>
...
<textarea id="myText"class="form-control pad" name="description"></textarea><br>
<span id="wordCount"  class="label_border pad">0</span><span>Characeter. Most search engines use a maximum of 160 characters for the description.</span><br>
<br>
