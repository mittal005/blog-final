...
</div><input id="myText" type="text" class="pad form-control" name="seo_title" value="<?php echo $seo_title;   ?>"><br>
<span id="wordCount" class="label_border pad">0</span><span>Characeter. Most search engines use a maximum of 60 characters for the Title.</span><br><br>
...
<textarea id="myText1" class="form-control pad" name="description"><?php echo $description;   ?></textarea><br>
<span id="wordCount1" class="label_border pad">0</span><span>Characeter. Most search engines use a maximum of 160 characters for the description.</span><br>
<br>
...
<div id="publish">
    ...
    <button type="button" class="btn btn-primary mar_top_20" onclick="displayRadioValue()"> 
     ...
     <br>
     <input type="submit" class="btn btn-primary col-md-4" name="update" value="Update">
