...
<form><input type="text" class="pad form-control" name="seo_title"onKeyDown="textCounter1(this.form.seo_title,this.form.countDisplay1);" onKeyUp="textCounter1(this.form.seo_title,this.form.countDisplay1);"><br>
...
<form>
<textarea class="form-control pad" name="description"onKeyDown="textCounter(this.form.description,this.form.countDisplay1);" onKeyUp="textCounter(this.form.description,this.form.countDisplay1);"></textarea><br>
<input readonly type="text" name="countDisplay1" size="3" maxlength="3" value="0"><span> Characters Remaining</span><br>
</form><br>
<br>
...
?>
      ...
      <div class="modal-footer">
        ...
        <a href='#' target="_blank"><button type="button" class="btn btn-primary">Back</button></a>
      </div>
  </div>
</div>
