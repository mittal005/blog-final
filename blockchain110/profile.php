...
if (isset($_POST['update_users'])) {
   ...
   $query="UPDATE newuser SET username='$username',password='$password',firstname='$firstname',lastname='$lastname',email='$email',role='$user_role',NickName='$NickName',Biographicalinfo='$Biographicalinfo',ProfilePicture='$post_image' WHERE id={$update_id}";
