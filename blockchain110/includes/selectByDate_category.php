...
$select_by_author_query="SELECT * FROM category  WHERE  category_date='{$publihedOn}' LIMIT $page_1,$per_page";
  ...
  <?php
   for($i =1; $i <= $count; $i++) {
        ...
        if($i == $page) {
             ...
             echo "<li class='page-item'><a class='page-link active_pagination' href='./newcategory.php?page&&pagecat={$i}'>{$i}</a></li>";


        }  else {

            echo "<li class='page-item''><a class='page-link' href='./newcategory.php?page&&pagecat={$i}'>{$i}</a></li>";
